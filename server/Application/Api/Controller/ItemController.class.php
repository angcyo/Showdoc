    ...
    private function _show_regular_item($item){
        ...
        if ($keyword) {
            ...
            foreach ($pages as $k => $v) {
                //修改一级页面标题
                $pages[$k] = $this->changePageTitle($pages[$k]);
            }
            ...
            if ($catalogs) {
                foreach ($catalogs as $key => &$catalog) {
                    ...
                    foreach ($catalog['pages'] as $k => $v) {
                        //修改二级页面标题
                        $catalog['pages'][$k] = $this->changePageTitle($catalog['pages'][$k]);
                    }
                    ...
                    if($catalog['catalogs']){
                        ...
                        foreach ($catalog['catalogs'] as $key3 => &$catalog3) {
                            ...
                            foreach ($catalog['pages'] as $k => $v) {
                                //修改三级页面标题
                                $catalog3['pages'][$k] = $this->changePageTitle($catalog3['pages'][$k]);
                            }
                        }
                    }
                }
